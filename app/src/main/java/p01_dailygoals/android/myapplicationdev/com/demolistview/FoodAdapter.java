...
public class FoodAdapter extends ArrayAdapter<MainActivity.Food> {
    private ArrayList<MainActivity.Food> food;
    private Context context;
    private TextView tvFoodName;
    private ImageView ivStar;

    public FoodAdapter(Context context, int resource, ArrayList<MainActivity.Food> objects){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MainActivity.Food currentFood = food.get(position);
